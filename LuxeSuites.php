            ...
            <main class="content">
                ...
                <div class="page-content">
                    <div class="container-fluid">
                          <div class="bg-white table-responsive rounded shadow-sm pt-3 pb-3 mb-30">
                            ...
                            <table id="data-table" class="table mb-0 table-striped" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <?php
                                        $i=1;
                                        $Orders = "SELECT * FROM orders WHERE Hotel_Name = 'LuxeSuites'";
                        ...
                        <div class="bg-white table-responsive rounded shadow-sm pt-3 pb-3 mb-30">
                              <h6 class="pl-3 pr-3 text-capitalize font400 mb-20">Purchases For LuxeSuites</h6>
                            <table id="data-table" class="table mb-0 table-striped" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th >PurchaseID</th>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $Purchases = "SELECT * FROM purchases INNER JOIN orders on purchases.OrderID=orders.OrderID Where orders.Hotel_Name='LuxeSuites'";
